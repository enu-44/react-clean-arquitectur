...
@injectable()
export class DeleteTaskUseCase extends Command<Promise<Result<NoResult, Failure>>,number> {
    constructor(
    ...
    execute = (params: number): Promise<Result<NoResult, Failure>> => this._taskRepository.deleteById(params);
}